...
const I18N = {
  en: {
    ...
    input_header_hell: "🔥 Hell Phase",
    input_header_florence: "🏛️ Florence Phase",
    input_header_turn_end: "⏳ Turn End",
    input_header_reshuffle: "🔄 Reshuffle",
    phase_setup: "Setup",
...
• Beige Barrel = Yellow priority, Burgundy Barrel = Purple priority.`,
  ...
  es: {
    ...
    input_header_hell: "🔥 Fase del Infierno",
    input_header_florence: "🏛️ Fase de Florencia",
    input_header_turn_end: "⏳ Fin de Turno",
    input_header_reshuffle: "🔄 Rebarajar",
