...
const I18N = {
  en: {
    ...
    guidance_shield: "Shield Placement",
    guidance_exchange: "Florin Exchange",
    guidance_location: "Priority Location",
    guidance_tie: "Tie-breaking",
    guidance_tower: "Tower Guest Order",
...
• Beige Barrel = Yellow priority, Burgundy Barrel = Purple priority.`,
  ...
  es: {
    ...
    guidance_shield: "Colocación en Escudo",
    guidance_exchange: "Cambio de Florines",
    guidance_location: "Ubicación Prioritaria",
    guidance_tie: "Desempate",
    guidance_tower: "Orden Invitados Torre",
